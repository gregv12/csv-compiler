...
/**
 * A character stream whose source is a string, the String can be replaced and the pointers reset within this class.
 *
 * This class is not thread safe, all reading and writing should be on the same thread.
 *
 * Derived from {@link java.io.StringReader}
 *
 */

class OverwritingStringReader extends Reader {
     ...
     */
    public OverwritingStringReader(String s) {
        this.length = s.length();
        this.str = s;
    }

    public OverwritingStringReader(){
        this("");
    }

    public void append(String stringToAppend) {
        this.length = stringToAppend.length();
